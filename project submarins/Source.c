...
void print_rules_of_submarin_plasment_massege();
...
//convenience
void pause();
void clear(); // builded by Moshe
//
int random(int Nmin, int Nmax); // builded by GPT for testing
...
int main()
{
	...
	do
	{
		print_rules_of_submarin_plasment_massege();
...
void print_rules_of_submarin_plasment_massege()
{
	...
	ff("\t\t\t\t\t###############################\n");
	ff("\t\t\t\t\t#                             #\n");
	ff("\t\t\t\t\t#%s   submarin plasment rules:  %s#\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#                             #\n");
	ff("\t\t\t\t\t#                             #\n");
	ff("\t\t\t\t\t#%s 1: Choose the orientation%s   #\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#%s    to place the submarine%s   #\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#                             #\n");
	ff("\t\t\t\t\t#%s    to place it horizontally %s#\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#%s    press %s1                  %s#\n", YELLOW,WHITE, GREEN);
	ff("\t\t\t\t\t#                             #\n");
	ff("\t\t\t\t\t#%s    to place it vertically  %s #\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#%s    press %s2                  %s#\n", YELLOW,WHITE, GREEN);
	ff("\t\t\t\t\t#                             #\n");
	ff("\t\t\t\t\t#%s 2: You are not allowed to   %s#\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#%s    place the submarine      %s#\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#%s    on red or black cell     %s#\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#                             #\n");
	ff("\t\t\t\t\t#%s 3: The submarine must be    %s#\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#%s    placed within the        %s#\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#%s    boundaries of the board  %s#\n", YELLOW, GREEN);
	ff("\t\t\t\t\t#                             #\n");
	ff("\t\t\t\t\t###############################\n");
	ff("\n\n\t\t\t\t\t");
	yellow();
